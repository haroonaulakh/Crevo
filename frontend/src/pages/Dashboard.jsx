...
import { LogOut, User, Plus, CheckCircle, X, UserMinus, Calendar } from 'lucide-react';
          ...
          <div className="dashboard-hero">
            ...
            <div className="hero-content-inner">
              ...
              <div className="hero-actions">
                ...
                <button onClick={() => navigate('/teachers')} className="view-teachers-btn hero-btn" style={{ background: 'linear-gradient(135deg, #047857, #10b981)', color: 'white', border: 'none', padding: '0.8rem 1.5rem', borderRadius: '0.75rem', fontWeight: '700', fontSize: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer', transition: 'all 0.2s ease', boxShadow: '0 4px 15px rgba(4,120,87,0.3)' }}>
                  <User size={22} />
                  View Teachers
                </button>
                ...
                <button onClick={() => navigate('/timetable')} className="timetable-btn hero-btn" style={{ background: 'linear-gradient(135deg, #7c3aed, #a78bfa)', color: 'white', border: 'none', padding: '0.8rem 1.5rem', borderRadius: '0.75rem', fontWeight: '700', fontSize: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer', transition: 'all 0.2s ease', boxShadow: '0 4px 15px rgba(124,58,237,0.3)' }}>
                  <Calendar size={22} />
                  Timetable Generator
                </button>
              </div>
